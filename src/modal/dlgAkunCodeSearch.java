...
public class dlgAkunCodeSearch extends javax.swing.JDialog {
    ...
    private void loadAllDatabase() {
        removeTableData();
        try {
            String sql = "SELECT * FROM accountchart where chartno in (1010,1020,3030);";
            ...
            Logger.getLogger(dlgAkunCodeSearch.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
