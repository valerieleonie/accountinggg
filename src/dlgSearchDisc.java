 ...
 * @author COMPUTER
 */
public class dlgSearchDisc extends javax.swing.JDialog {
    
    private Connection conn;
    /**
     * Creates new form dlgDisc
     */
    public dlgSearchDisc(java.awt.Frame parent, boolean modal, Connection conn) {
        super(parent, modal);
        this.conn = conn;
        initComponents();
        loadAllDatabase();
    ...
    private void loadAllDatabase() {
        try {
            ...
            Logger.getLogger(dlgSearchDisc.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
