 ...
 * @author COMPUTER
 */
public class dlgSearchDiscSupplier extends javax.swing.JDialog {
    
    private Connection conn;
    /**
     * Creates new form dlgDisc
     */
    public dlgSearchDiscSupplier(java.awt.Frame parent, boolean modal, Connection conn) {
        super(parent, modal);
        this.conn = conn;
        initComponents();
        loadAllDatabase();
